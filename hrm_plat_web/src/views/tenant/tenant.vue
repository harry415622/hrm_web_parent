<template>
    ...
    private Long pid;
		...
		<el-table :data="tenants" v-loading="listLoading" highlight-current-row  style="width: 100%;">
			...
			<el-table-column prop="parent.companyName" label="父类型">
			</el-table-column>
		...
		<el-dialog title="添加或修改" :visible.sync="formVisible" :close-on-click-modal="false">
			<el-form :model="course" label-width="80px" :rules="formRules" ref="course">
				<el-form-item label="名称" prop="companyName">
					<el-input v-model="course.companyName" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="标识" prop="sn">
					<el-input v-model="course.sn" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="路径" prop="dirPath">
					<el-input v-model="course.dirPath" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="状态" prop="state">
					<el-radio-group v-model="course.state" >
						<el-radio checked="checked" :label="0">正常</el-radio>
						<el-radio  :label="-1">停用</el-radio>
					</el-radio-group>
				</el-form-item>
				<el-form-item label="部门经理" prop="manager">
					<el-select v-model="course.manager" placeholder="请选择">
						<el-option
								v-for="item in employees"
								:key="item.id"
								:label="item.usercompanyName"
								:value="item.id">
							<span style="float: left">{{ item.id }}</span>
							<span style="float: right; color: #8492a6; font-size: 13px">{{ item.usercompanyName }}</span>
						</el-option>
					</el-select>
				</el-form-item>
			</el-form>
